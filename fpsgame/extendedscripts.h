...
"newgui editplayersearch [\n"
    ...
    "guistayopen [\n"
        "guilist [\n"
            ...
            "guitext \"title \"\n"
            "ntitle = $currenttitle\n"
            "guifield ntitle 30 [currenttitle = $ntitle]\n"
            "guistrut 1\n"
            "nsearch = (escape $currenttitle)\n"
            "ensearch = (escape $nsearch)\n"
            "if (&& (!=s $currentsearch \"\") (!=s $currenttitle \"\") (|| (=s (stringify $currentsearch) $nsearch) (! (getplayersearch $nsearch)))) [\n"
             ...
             "]\n"
             "if (&& (=s $currentsearch \"\") (!=s $currenttitle \"\") (! (getplayersearch $nsearch))) [\n"
