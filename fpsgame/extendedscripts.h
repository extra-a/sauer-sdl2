    ...
    "guistayopen [\n"
        "guilist [\n"
            ...
            "if (&& (!=s $currentsearch \"\") (!=s $currenttitle \"\") (|| (=s (stringify $currentsearch) $nsearch) (! (playersearchexists $nsearch)))) [\n"
                "guibutton \"save changes  \" [textfocus \"#patterneditor\"; currentfilters = (escape (textshow)); updateplayersearch $currentsearch $currentfilters @ensearch; currentsearch = (at (escape $currenttitle)); hidegui editplayersearch] \"checkbox_on\"\n"
             ...
             "if (&& (=s $currentsearch \"\") (!=s $currenttitle \"\") (! (playersearchexists $nsearch))) [\n"
                "guibutton \"save changes  \" [textfocus \"#patterneditor\"; currentfilters = (escape (textshow)); updateplayersearch @nsearch $currentfilters @ensearch; currentsearch = (at (escape $currenttitle)); hidegui editplayersearch] \"checkbox_on\"\n"
             "]\n"
        "]\n"
        "guistrut 1\n"
        "guilist [\n"
