...
"newgui playersearches [\n"
    ...
    "guilist [\n"
        "guispring\n"
        "guibutton \"new search\" [currentsearch = \"untitled\"; showgui players]\n"
        "guispring\n"
    "]\n"
    "guibar\n"
    "looplist s $savedsearches [\n"
        "guilist [\n"
            "ntitle = (at $s 0)\n"
            "guibutton $ntitle [currentsearch = [@@ntitle]; showgui players]\n"
        "]\n"
    "]\n"
"]\n"
"] \"searches\"\n"
"setsearch = [\n"
    ...
    "textclear\n"
    "currentfilters = (getplayersearch $currentsearch)\n"
    "setguieditorcontent \"#patterneditor\" $currentfilters\n"
"]\n"
"newgui editplayersearch [\n"
    "guistayopen [\n"
        "guilist [\n"
            ...
            "guistrut 1\n"
            "guibutton \"save changes  \" [textfocus \"#patterneditor\"; currentfilters = (textshow); currentsearch = $currenttitle; updateplayersearch $currentsearch $currentfilters; hidegui editplayersearch] \"checkbox_on\"\n"
            "guibutton \"discard changes  \" [hidegui editplayersearch] \"arrow_bw\"\n"
            "guibutton \"delete search  \" [deleteplayersearch $currenttitle; currentsearch = \"\"; hidegui editplayersearch] \"exit\"\n"
        "]\n"
        "guistrut 1\n"
        "guilist [\n"
...
"updateplayersearch = [\n"
    "if (&& (!=s $arg1 \"\")) [\n"
        "local foundname i node nsearches\n"
        "foundname = -1\n"
        "i = 0\n"
        ...
        "node = [[[@@@arg1] [@@@arg2]]]\n"
        "if (= $foundname -1) [\n"
            "nsearches = (listsplice $savedsearches $node $i 0)\n"
        "] [\n"
            "nsearches = (listsplice $savedsearches $node $foundname 1)\n"
        "]\n"
        "(overwritesearches $nsearches)\n"
    "]\n"
"] \n"
"getplayersearch = [\n"
    "local res\n"
...
"deleteplayersearch = [\n"
    "if (&& (!=s $arg1 \"\")) [\n"
        ...
        "]\n"
        "if (!= $foundname -1) [\n"
            "nsearches = (listsplice $savedsearches [] $foundname 1)\n"
            "(overwritesearches $nsearches)\n"
        "]\n"
    "]\n"
"] \n";
